...
<div class="wrap lpf-page support-page">
	...
	<div class="lpf-page-content lpf-support-page-content">		
		<div class="cptpro-settings cptpro-settings-support-help-container">
			...
			<h2>
				<span class="dashicons dashicons-wordpress-alt"></span> <?php esc_html_e( 'WordPress.org Support Forums', 'yikes-level-playing-field' ); ?>
			</h2>

			<p>
				<?php esc_html_e( 'If you need help, please post questions to our support forum on the WordPress Plugin Directory.', 'yikes-level-playing-field' ); ?> <a href="https://wordpress.org/support/plugin/level-playing-field#new-post" target="_blank">
					<?php esc_html_e( 'Go to the free Support Forum on WordPress.org', 'yikes-level-playing-field' ); ?>
				</a>
			</p>

			<p>
				<a class="button button-primary" href="https://wordpress.org/support/plugin/level-playing-field#new-post" target="_blank">
					<?php esc_html_e( 'Submit a Support Request', 'yikes-level-playing-field' ); ?>
				</a>
			</p>
		</div>
	</div>
