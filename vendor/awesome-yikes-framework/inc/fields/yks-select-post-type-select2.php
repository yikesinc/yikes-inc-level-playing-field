<?php
/**** Select Post Type Select2 Field ****/
...
if ( ! empty( $posts ) ) {
	...
	wp_enqueue_style( 'select2-css-4.0.3', YKS_MBOX_URL . 'css/select2/select2.min.css' );
	wp_enqueue_script( 'select2-js-4.0.3', YKS_MBOX_URL . 'js/select2/select2.min.js', array( 'jquery' ) );
