...
function yikes_get_file_template_location( $field ) {
	...
	} elseif ( file_exists( ( YIKES_AWESOME_FRAMEWORK_PATH . '/inc/fields/yks-' . $field_name_with_dashes . '.php' ) ) !== false ) {

		return YIKES_AWESOME_FRAMEWORK_PATH . '/inc/fields/yks-' . $field_name_with_dashes . '.php';
