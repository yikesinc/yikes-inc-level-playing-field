...
/**
 * Class ApplicantMessagingPage
 *
 * @since   %VERSION%
 * @package Yikes\LevelPlayingField
 */
class ApplicantMessagingPage extends BaseRequiredPage {

	const PAGE_SLUG      = 'lpf-messaging-page';
	const POST_TITLE     = 'Applicant Messaging';
	...
	protected function get_post_state() {
		return __( 'Level Playing Field\'s Applicant Messaging Page', 'yikes-level-playing-field' );
	}
}
