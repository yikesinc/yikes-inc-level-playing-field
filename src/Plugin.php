...
final class Plugin implements Registerable {
	...
	public function plugin_action_links( $links ) {
		$lpf_links = [
			SettingsPage::PAGE_SLUG => '<a href="' . esc_url( ( new SettingsPage() )->get_page_url() ) . '">' . __( 'Settings', 'yikes-level-playing-field' ) . '</a>',
			SupportPage::PAGE_SLUG  => '<a href="' . esc_url( ( new SupportPage() )->get_page_url() ) . '">' . __( 'Support', 'yikes-level-playing-field' ) . '</a>',
			JobManager::SLUG        => '<a href="' . esc_url( ( new JobManager() )->get_add_new_url() ) . '">' . __( 'Add a Job', 'yikes-level-playing-field' ) . '</a>',
			GoProPage::PAGE_SLUG    => '<a href="' . esc_url( ( new GoProPage() )->get_page_url() ) . '">' . __( 'Go Pro', 'yikes-level-playing-field' ) . '</a>',
		];
