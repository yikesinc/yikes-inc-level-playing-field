		...
		$job_boxes = [
			...
			'fields'     => [
				[
					...
					'default_option' => __( 'Select Status', 'yikes-level-playing-field' ),
				...
				[
					...
					'default_option' => __( 'Select Application Form', 'yikes-level-playing-field' ),
				...
				[
					...
					'desc'           => __( "Choose the page for this job's application form. You can use the page automatically generated by LPF or a custom page.", 'yikes-level-playing-field' ),
					'default_option' => __( 'Select Application Form Page', 'yikes-level-playing-field' ),
